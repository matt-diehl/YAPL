...
module.exports = function(config) {
    ...
    function copyAssets() {
        var cssFilename = path.basename(config.settings.libraryCss),
            ...
            codeHighlightJsFilename = path.basename(config.settings.libraryCodeHighlightJs),
            codeHighlightJsOutputPath = path.join(config.settings.buildDir, codeHighlightJsFilename);
        utils.copyFile(config.settings.libraryCss, cssOutputPath);
        utils.copyFile(config.settings.libraryJs, jsOutputPath);
        utils.copyFile(config.settings.libraryCodeHighlightJs, codeHighlightJsOutputPath);
