...
var utils = module.exports = {
     ...
     */
    getImagePathsFromHtml: function(html, siteRoot) {
     ...
     */
    getImageDimensionsFromHtml: function(html, siteRoot) {
        var images = utils.getImagePathsFromHtml(html, siteRoot),
            sizeIds = [];

        images = images.map(function(image) {
            return utils.dimensions(image);
        }).filter(function(image) {
            var sizeId = image.join('x');
     ...
     */
    findMatchingSelectors: function(html, selectors) {
        var $ = cheerio.load(html),
            $matches,
            filteredSelectors = [];
        ...
        filteredSelectors = selectors.filter(function(selector) {
    ...
    linkFromRoot: function(root, link) {
